...
fill ~-1 ~-1 ~-1 ~1 ~1 ~1 repeating_command_block 0 keep {Command:"/function exxabite:melt2",auto:1b}

fill ~-1 ~-1 ~-1 ~1 ~ ~1 air 0 replace dirt 0
fill ~-1 ~-1 ~-1 ~1 ~ ~1 repeating_command_block 0 keep {Command:"/function exxabite:melt3",auto:1b}
